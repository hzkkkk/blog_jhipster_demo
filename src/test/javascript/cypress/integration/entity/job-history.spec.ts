...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-09-02T07:44').should('have.value', '2021-09-02T07:44');

    cy.get(`[data-cy="endDate"]`).type('2021-09-01T21:52').should('have.value', '2021-09-01T21:52');
