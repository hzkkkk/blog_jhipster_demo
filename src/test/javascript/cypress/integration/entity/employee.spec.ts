...
describe('Employee e2e test', () => {
  ...
  it('should create an instance of Employee', () => {
    ...
    cy.get(`[data-cy="firstName"]`).type('彬').should('have.value', '彬');

    cy.get(`[data-cy="lastName"]`).type('丁').should('have.value', '丁');

    cy.get(`[data-cy="email"]`).type('烨霖.马@yahoo.com').should('have.value', '烨霖.马@yahoo.com');

    cy.get(`[data-cy="phoneNumber"]`).type('Mandatory Generic open').should('have.value', 'Mandatory Generic open');

    cy.get(`[data-cy="hireDate"]`).type('2021-09-01T09:01').should('have.value', '2021-09-01T09:01');

    cy.get(`[data-cy="commissionPct"]`).type('24764').should('have.value', '24764');

    cy.get(`[data-cy="salar"]`).type('97402').should('have.value', '97402');
